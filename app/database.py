...
# Example for SQLite:
SQLALCHEMY_DATABASE_URL = "postgresql://neondb_owner:W3FMILeyHkP0@ep-long-union-a5mh444q-pooler.us-east-2.aws.neon.tech/neondb?sslmode=require"#"sqlite:///./app.db"
